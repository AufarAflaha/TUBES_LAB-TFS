...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah Ruang Kuliah</h1>
                ...
                <form action="{{ route('rooms.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('facilities') is-invalid @enderror" 
                                  ...
                                  placeholder="Contoh: AC, Proyektor, Whiteboard, Sound System">{{ old('facilities') }}</textarea>
                        @error('facilities')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="{{ route('rooms.index') }}" class="btn btn-secondary me-md-2">Batal</a>
